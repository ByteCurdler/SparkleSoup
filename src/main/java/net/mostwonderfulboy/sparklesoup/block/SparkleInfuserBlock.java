...
import net.mostwonderfulboy.sparklesoup.gui.SparkleInfuserGUIGui;
...
public class SparkleInfuserBlock extends SparklesoupModElements.ModElement {
	@ObjectHolder("sparklesoup:sparkle_infuser")
	public static final Block block = null;
	public SparkleInfuserBlock(SparklesoupModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sparkle_infuser");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Sparkle Infuser");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new SparkleInfuserGUIGui.GuiContainerMod(id, inventory,
