...
import net.mostwonderfulboy.sparklesoup.procedures.SportleVinesPlantRightClickedProcedure;
...
public class SportleVinesBlock extends SparklesoupModElements.ModElement {
	@ObjectHolder("sparklesoup:sportle_vines")
	public static final Block block = null;
	public SportleVinesBlock(SparklesoupModElements instance) {
		super(instance, 30);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS, MaterialColor.EMERALD).tickRandomly().doesNotBlockMovement().sound(SoundType.GROUND)
					.hardnessAndResistance(0.1f, 0f).lightValue(8));
			setRegistryName("sportle_vines");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SportleBlock.block, (int) (2)));
		}
