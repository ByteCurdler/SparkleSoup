...
public class SportleEggItem extends SparklesoupModElements.ModElement {
	@ObjectHolder("sparklesoup:sportle_egg")
	public static final Item block = null;
	public SportleEggItem(SparklesoupModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Smelt to make a Sportle flower"));
		}
	}
}
